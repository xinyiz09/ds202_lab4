...
TeamISU <- inner %>%
  filter(State == " Iowa") %>%
  mutate(Rushing_YDS = sum(Rushing_YDS, na.rm = T)) %>%
  mutate(Rushing_ATT = sum(Rushing_ATT, na.rm = T)) %>%
  mutate(Rushing_TD = sum(Rushing_TD, na.rm = T)) %>%
  mutate(Receiving_REC = sum(Receiving_REC, na.rm = T)) %>%
  mutate(Receiving_YDS = sum(Receiving_YDS, na.rm = T)) %>%
  mutate(Receiving_TD = sum(Receiving_TD, na.rm = T)) %>%
  mutate(Passing_CMP_ATT = sum(Passing_CMP_ATT, na.rm = T)) %>%
  mutate(Passing_YDS = sum(Passing_YDS, na.rm = T)) %>%
  mutate(Passing_TD = sum(Passing_TD, na.rm = T)) %>%
  mutate(Passing_INT = sum(Passing_INT, na.rm = T))  
